...
public class Graph {
    ...
    //too and from places.
    private Graph createTransposedGraph(){
    ...
    private void DFSPrinter(int[] found, Stack<Integer> stack, Graph transposedGraph){
        while(!stack.empty()){
            int node = stack.pop();
    ...
    public void SCC(){
        ...
        Graph transposedGraph = createTransposedGraph();
